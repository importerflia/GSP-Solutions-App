...
async function createWindow() {
  win = new import_electron.BrowserWindow({
    title: "Main window",
    icon: (0, import_node_path.join)(process.env.PUBLIC, "LogoOscuro.png"),
    width: import_electron.screen.getPrimaryDisplay().workArea.width,
    height: import_electron.screen.getPrimaryDisplay().workArea.height,
